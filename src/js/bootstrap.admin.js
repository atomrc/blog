...
define(['angular', 'bootstrap.public'], function (angular, publicbootstrap) {
    'use strict';
    return function (app) {
        //init the public part of the application
        publicbootstrap(app);
            ...
            .directive('wscBodyCompiler', [function () {
                return {
                    ...
                    link: function ($scope, element, attrs, ngModel) {
                        ...
                        require(['libs/highlight.pack', 'libs/markdown'], function (hl, md) {
